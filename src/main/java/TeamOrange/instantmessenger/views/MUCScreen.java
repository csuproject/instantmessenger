...
/**
 * This is the muc screen. Users get here by pressing the Groups button.
 * This allows users to create mucs, and engage with mucs.
 *
 */
public class MUCScreen extends Screen {
	...
	/**
	 * Loads the screen based on the given input.
	 * @param input
	 */
